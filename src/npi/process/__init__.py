...
PC_COL_DICT = {'NPI': 'NPI',
               ...
               'org_nm': 'Organization legal name',
...
DTYPES = {'NPI': 'int',
          ...
          'Organization legal name': 'string',
          ...
          'Hospital affiliation CCN 1': 'string',
          'Hospital affiliation LBN 1': 'string',
          'Hospital affiliation CCN 2': 'string',
          'Hospital affiliation LBN 2': 'string',
          'Hospital affiliation CCN 3': 'string',
          'Hospital affiliation LBN 3': 'string',
          'Hospital affiliation CCN 4': 'string',
          'Hospital affiliation LBN 4': 'string',
          'Hospital affiliation CCN 5': 'string',
